...
if(isset($_POST['login']))
  {
    ...
    $check="administrator";
    $query=mysqli_query($con,"select ID from tbladmin where  UserName='$adminuser' OR && Password='$password' && AdminName='$check' ")
...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header">ED-Directory Management System Login</div>
      <div class="card-body">
